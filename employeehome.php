...
<body>
        ...
        <table cellspacing="0" cellpadding="0"  width="425">
            ...
            <tr>
                ...
                <div style="width:425px; height:200px; overflow-y:auto;">
                    <table cellspacing="8" cellpadding="1" width="400" style="text-align:center;" >
                    <?php 
                            if(isset($_GET['search1']))
                                {
                                    ...
                                    while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                                        print "<tr><td>";
                                        print '<a href="viewpatient.php?id='.$row['id'].'&fName='.$row['fName'].'&lName='.$row['lName'].'" class="btn btn-primary btn-sm" role="button" aria-pressed="true">'.$row["id"].'</a>';
                                        print "</td><td>";
    ...
    <form action="" method="GET">
        ...
        <table cellspacing="0" cellpadding="0"  width="425">
            <tr>
                <td>
                    <table cellspacing="0" cellpadding="5px 5px" width="420" style="margin-left:2px;" >
                        <tr>
                            <th>ID</th>
                            <th>Sent Date</th>
                            <th>Title</th>
            ...
            <tr>
                <td>
                    <div style="width:425px; height:200px; overflow-y:auto;">
                        <table cellspacing="0" cellpadding="1" width="400" style="text-align:center; margin-left: 18px;" >
                            <?php 
